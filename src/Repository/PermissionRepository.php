...
final class PermissionRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`permissions`' : '"permissions"';
     ...
     * [ 'description', 'updated_at' ] = které sloupce aktualizovat.
     */

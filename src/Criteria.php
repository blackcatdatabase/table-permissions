...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'name', 'description', 'created_at', 'updated_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\Permissions\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\Permissions\Definitions::softDeleteColumn();

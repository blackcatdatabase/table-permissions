...
namespace BlackCat\Database\Packages\Permissions\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO PermissionDto:
 ...
 */
final class PermissionDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'name' => 'name', 'description' => 'description', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];
     ...
     */
    public static function fromRow(array $row): PermissionDto
    {
        /** @var PermissionDto */
    ...
    public static function fromRowOrNull(?array $row): ?PermissionDto
    {
     ...
     */
    public static function toRow(PermissionDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(PermissionDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(PermissionDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,PermissionDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,PermissionDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(PermissionDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,PermissionDto>
     */

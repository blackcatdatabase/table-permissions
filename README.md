...
> Lineage: 0 outbound / 2 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 1 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\permissions](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\permissions) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package permissions -Apply

...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 0 outbound / 2 inbound · ✅ No engine drift detected · Index coverage: todo · PII: 1 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\permissions](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\permissions)
...
graph LR
  ...
  rbac_role_permissions["rbac_role_permissions"]:::inbound -->|FK| permissions
  rbac_user_permissions["rbac_user_permissions"]:::inbound -->|FK| permissions
...
- Inbound (relies on this): "rbac_role_permissions", "rbac_user_permissions"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package permissions -Apply
